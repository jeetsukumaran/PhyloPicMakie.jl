...
thumbnail gallery from PhyloPic records, images, and labels. Use the runnable
...
[how-to guides](how-to/index.md) for a plotting task, read [concepts](explanation/index.md)
for context, consult the [API reference](api/rendering.md) for exact facts, or
run an [example](examples.md) when you want working scripts.
